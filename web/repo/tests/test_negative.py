...
class NegativeApiTestCase(APITestCase):
    ...
    def test_promote_without_target(self):
        ...
        Repository.objects.create(repo_uid="no-promo", repo_type="deb")
        pass
    ...
    def test_copy_incompatible_types(self):
        ...
        Repository.objects.create(repo_uid="dst-rpm", repo_type="rpm")
        ...
        response = self.client.post(
            f"/api/src-deb/pkg/{pkg.package_uid}/copy/",
